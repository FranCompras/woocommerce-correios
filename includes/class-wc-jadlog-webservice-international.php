<?php
/**
 * Jadlog Webservice International.
 *
...
/**
 * Jadlog Webservice International integration class.
 */
class WC_Jadlog_Webservice_International {
	 ...
	 * @var string
	 */
	private $_webservice = 'http://www2.jadlog.com.br/sistemas/efi/bb/Consulta.cfm?';
	 ...
	 * Set the service.
	 *
	 * @param string $service Jadlog international service.
	 */
	...
	public function get_webservice_url() {
		return apply_filters( 'woocommerce_jadlog_webservice_international_url', $this->_webservice, $this->id, $this->instance_id, $this->package );
	}
	...
	public function get_allowed_countries() {
		return apply_filters( 'woocommerce_jadlog_international_allowed_countries', array(
			'AD',
			'AE',
			'AF',
			'AG',
	...
	public function get_origin_location() {
		...
		return apply_filters( 'woocommerce_jadlog_international_origin_location', $this->origin_location, $this->id, $this->instance_id, $this->package );
	}
	...
	public function get_origin_state() {
		return apply_filters( 'woocommerce_jadlog_international_origin_state', $this->origin_state, $this->id, $this->instance_id, $this->package );
	}
	...
	public function get_shipping() {
		...
		$args = apply_filters( 'woocommerce_jadlog_international_shipping_args', array(
			'tipoConsulta' => 'Geral',
