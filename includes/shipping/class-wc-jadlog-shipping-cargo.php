<?php
/**
 * Jadlog Carta Registrada shipping method.
 *
 ...
 */
class WC_Jadlog_Shipping_Cargo extends WC_Jadlog_Shipping {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title       = __( 'Jadlog Cargo', 'woocommerce-jadlog' );
		$this->more_link          = '';
	 ...
	 * http://www.jadlog.com.br/para-voce/consultas-e-solicitacoes/precos-e-prazos/servicos-nacionais_pasta/carta
	 *
	 * @return array
	 */
	protected function get_costs() {
		return apply_filters( 'woocommerce_jadlog_carta_registrada_costs', array(
			'20'  => array(
				'R'     => 6.00,
				'AR'    => 10.30,
				'MP'    => 11.50,
