<?php
/**
 * Abstract Jadlog Impresso shipping method.
 *
...
/**
 * Default Jadlog Impresso shipping method abstract class.
 *
 * This is a abstract method with default options for all methods.
 */
abstract class WC_Jadlog_Shipping_Impresso extends WC_Jadlog_Shipping_Carta {

	/**
	 * National Registry cost.
	 *
	 * Cost based in 01/10/2016 from:
	 * http://www.jadlog.com.br/para-voce/consultas-e-solicitacoes/precos-e-prazos/servicos-adicionais-nacionais
	 *
	 * @var float
	 */
	 ...
	 *
	 * Cost based in 01/10/2016 from:
	 * https://www.jadlog.com.br/para-voce/consultas-e-solicitacoes/precos-e-prazos/servicos-adicionais-nacionais
	 *
	 * @var float
	 */
	 ...
	 * https://www.jadlog.com.br/para-voce/consultas-e-solicitacoes/precos-e-prazos/servicos-nacionais_pasta/impresso-normal
	 *
	 * @var float
	 */
	...
	public function init_form_fields() {
		$this->instance_form_fields = array(
			...
			'shipping_class' => array(
				...
				'type'        => 'select',
				'description' => __( 'Select for which shipping class this method will be applied.', 'woocommerce-jadlog' ),
				'desc_tip'    => true,
				'default'     => '',
			...
			'registry_type' => array(
				'title'       => __( 'Registry Type', 'woocommerce-jadlog' ),
				'type'        => 'select',
				'description' => __( 'Select for which registry type this method will be applied.', 'woocommerce-jadlog' ),
				'desc_tip'    => true,
				'default'     => '',
				'class'       => 'wc-enhanced-select',
				'options'     => array(
					''   => __( '-- Select a registry type --', 'woocommerce-jadlog' ),
					'RN' => __( 'Registro Nacional', 'woocommerce-jadlog' ),
					'RM' => __( 'Registro Módico', 'woocommerce-jadlog' ),
				),
				'default'     => 'RM',
			),
			...
			'additional_time' => array(
				'title'       => __( 'Delivery Days', 'woocommerce-jadlog' ),
				'type'        => 'text',
				'description' => __( 'Working days to the estimated delivery.', 'woocommerce-jadlog' ),
				'desc_tip'    => true,
				'default'     => '0',
				'placeholder' => '0',
			),
			...
			'optional_services' => array(
				'title'       => __( 'Optional Services', 'woocommerce-jadlog' ),
				'type'        => 'title',
				'description' => __( 'Use these options to add the value of each service provided by the Jadlog.', 'woocommerce-jadlog' ),
				'default'     => '',
			),
			'receipt_notice' => array(
				'title'       => __( 'Receipt Notice', 'woocommerce-jadlog' ),
				'type'        => 'checkbox',
				'label'       => __( 'Enable receipt notice', 'woocommerce-jadlog' ),
				'description' => __( 'This controls whether to add costs of the receipt notice service.', 'woocommerce-jadlog' ),
				'desc_tip'    => true,
				'default'     => 'no',
			),
			'own_hands' => array(
