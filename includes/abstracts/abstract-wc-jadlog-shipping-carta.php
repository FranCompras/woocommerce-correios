<?php
/**
 * Abstract Jadlog Carta shipping method.
 *
...
/**
 * Default Jadlog Carta shipping method abstract class.
 */
abstract class WC_Jadlog_Shipping_Carta extends WC_Jadlog_Shipping {
	...
	protected function get_shipping_classes_options() {
		...
		$options          = array(
			'' => __( '-- Select a shipping class --', 'woocommerce-jadlog' ),
		);
