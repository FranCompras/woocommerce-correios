<?php
/**
 * Abstract Jadlog international shipping method.
 *
...
/**
 * Default Jadlog international shipping method abstract class.
 *
 * This is a abstract method with default options for all methods.
 */
abstract class WC_Jadlog_Shipping_International extends WC_Jadlog_Shipping {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_description = sprintf( __( '%s is a international shipping method from Jadlog.', 'woocommerce-jadlog' ), $this->method_title );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
		);
	...
	public function init_form_fields() {
		$this->instance_form_fields = array(
			...
			'origin_state' => array(
				'title'       => __( 'Origin State', 'woocommerce-jadlog' ),
				'type'        => 'select',
				'description' => __( 'The UF of the location your packages are delivered from.', 'woocommerce-jadlog' ),
				'desc_tip'    => true,
				'default'     => '',
			...
			'origin_location' => array(
				'title'       => __( 'Origin Locale', 'woocommerce-jadlog' ),
				'type'        => 'select',
				'description' => __( 'The location of your packages are delivered from.', 'woocommerce-jadlog' ),
				'desc_tip'    => true,
				'default'     => 'C',
				'class'       => 'wc-enhanced-select',
				'options'     => array(
					'C' => __( 'Capital', 'woocommerce-jadlog' ),
					'I' => __( 'Interior', 'woocommerce-jadlog' ),
				),
			),
	...
	public function get_code() {
		return apply_filters( 'woocommerce_jadlog_shipping_method_code', $this->code, $this->id, $this->instance_id );
	}
	...
	protected function get_rate( $package ) {
		$api = new WC_Jadlog_Webservice_International( $this->id, $this->instance_id );
